...
class TRARunConfig:
    ...
    resource_layer_base_weight_x: float = 0.20
    resource_layer_base_weight_y: float = 0.40
    resource_layer_base_weight_z: float = 0.40
    resource_use_surrogate_calibrator: bool = True
    resource_destroy_candidate_pool_size: int = 6
    resource_destroy_candidate_pool_weights: Tuple[float, ...] = ()
    resource_candidate_pool_size: int = 8
    resource_candidate_pool_max_attempts: int = 40
    ...
    resource_force_rotate_threshold: int = 10
    resource_z_exact_fail_force_threshold: int = 3
    ...
    fixgurobi_enable_best_obj_stop: bool = True
    fixgurobi_cheap_gate: bool = True
    fixgurobi_final_validation: bool = True
    fixgurobi_final_validation_time_limit_sec: float = 1200.0
    ...
    resource_z_mode_switch_penalty: float = 3.0
    ...
    resource_z_queue_sort_weight: float = 0.05
    ...
    resource_joint_colocated_sort_on_accepted_only: bool = False
    resource_joint_colocated_sort_max_groups_per_candidate: int = 3
    resource_gurobi_like_sort_noise_weight: float = 2.0
    resource_gurobi_like_sort_span_weight: float = 0.20
    resource_gurobi_like_sort_bonus: float = 1.0
    resource_y_robot_count_penalty: float = 6.0
    resource_y_robot_available_time_weight: float = 0.25
