...
RESOURCE_TIME_ITER_COLUMNS = [
    ...
    "force_rotate_used",
    "available_layers",
    "selected_layer_source",
    "xyz_skip_reason",
    "critical_path_operator_used",
    ...
    "fixgurobi_bound",
    "fixgurobi_gap",
    "fixgurobi_solve_time",
    "fixgurobi_wall_time",
    "fixgurobi_cache_hit",
    "fixgurobi_fixed_scope",
    "fixgurobi_infeasible_reason",
    "residual_hat",
    ...
    "acceptance_mode",
    "lahc_threshold",
    "multi_start_restart_count",
    "global_eval_triggered",
    "validation_trigger",
    "validated_makespan",
    "tail_guard_rejected",
    "tail_guard_reason",
    "candidate_latest_robot_finish",
    "candidate_active_robot_count",
...
def build_iter_row(
    ...
    row = {
        "iter": int(iter_id),
        "case": str(extra.get("case", "")),
        "focus": str(layer).upper(),
        "selected_layer": str(layer).upper(),
        ...
        "eval_backend": str(getattr(eval_result, "metadata", {}).get("eval_backend", "surrogate")),
        "fixgurobi_status": str(getattr(eval_result, "metadata", {}).get("fixgurobi_status", "")),
        "fixgurobi_obj": getattr(eval_result, "metadata", {}).get("fixgurobi_obj", ""),
        "fixgurobi_bound": getattr(eval_result, "metadata", {}).get("fixgurobi_bound", ""),
        "fixgurobi_gap": getattr(eval_result, "metadata", {}).get("fixgurobi_gap", ""),
        "fixgurobi_solve_time": getattr(eval_result, "metadata", {}).get("fixgurobi_solve_time", ""),
        "fixgurobi_wall_time": getattr(eval_result, "metadata", {}).get("fixgurobi_wall_time", ""),
        "fixgurobi_cache_hit": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_cache_hit", False)),
        "fixgurobi_fixed_scope": str(getattr(eval_result, "metadata", {}).get("fixgurobi_fixed_scope", "")),
        "fixgurobi_infeasible_reason": str(getattr(eval_result, "metadata", {}).get("fixgurobi_infeasible_reason", "")),
