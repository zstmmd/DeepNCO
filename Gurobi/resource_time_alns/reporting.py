...
RESOURCE_TIME_ITER_COLUMNS = [
    ...
    "fixgurobi_wall_time",
    "fixgurobi_cache_hit",
    "fixgurobi_local_fallback_cache_hit",
    ...
    "fixgurobi_cheap_gate_reject",
    "fixgurobi_compiled_fallback_used",
    "fixgurobi_fixed_scope",
    "fixgurobi_config_subtask_count",
    "fixgurobi_release_subtask_count",
    "fixgurobi_payload_fixed_x_order_count",
    "fixgurobi_payload_fixed_y_order_count",
    "fixgurobi_payload_fixed_z_order_count",
    "fixgurobi_payload_fixed_x_row_count",
    "fixgurobi_payload_fixed_y_row_count",
    "fixgurobi_payload_fixed_z_row_count",
    ...
    "lb_gate_skipped",
    "outer_exact_obj",
    "outer_fixgurobi_time",
    "cycle_id",
    "mark",
    "target_guidance_disabled",
]
...
RESOURCE_TIME_CANDIDATE_COLUMNS = [
    ...
    "projection_mode",
    "projection_repaired_subtask_count",
    "projection_z_repair_fail_count",
    "projection_z_repair_fail_reasons",
    "projection_z_repair_failed_subtask_ids",
    "F_raw",
    "F_cal",
    "eval_backend",
    "fixgurobi_status",
    ...
    "local_release_subtask_count",
    "local_release_initial_count",
    "local_release_retry_count",
    "revolving_enabled",
    "released_layer",
    "fixed_layers",
    "inner_relaxed_obj",
...
def build_iter_row(
    ...
    row = {
        ...
        "fixgurobi_local_fallback_cache_hit": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_local_fallback_cache_hit", False)),
        "fixgurobi_compile_cache_hit": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_compile_cache_hit", False)),
        "fixgurobi_compile_time": getattr(eval_result, "metadata", {}).get("fixgurobi_compile_time", ""),
        "fixgurobi_compile_cache_hit_count": getattr(eval_result, "metadata", {}).get("fixgurobi_compile_cache_hit_count", ""),
        "fixgurobi_compile_cache_miss_count": getattr(eval_result, "metadata", {}).get("fixgurobi_compile_cache_miss_count", ""),
        "fixgurobi_stage": str(getattr(eval_result, "metadata", {}).get("fixgurobi_stage", "")),
        "fixgurobi_cutoff": getattr(eval_result, "metadata", {}).get("fixgurobi_cutoff", ""),
        "fixgurobi_refined": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_refined", False)),
        "fixgurobi_coarse_obj": getattr(eval_result, "metadata", {}).get("fixgurobi_coarse_obj", ""),
        "fixgurobi_coarse_status": str(getattr(eval_result, "metadata", {}).get("fixgurobi_coarse_status", "")),
        "fixgurobi_coarse_proven_no_improve": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_coarse_proven_no_improve", False)),
        "fixgurobi_coarse_time": getattr(eval_result, "metadata", {}).get("fixgurobi_coarse_time", ""),
        "fixgurobi_refine_time": getattr(eval_result, "metadata", {}).get("fixgurobi_refine_time", ""),
        "fixgurobi_full_time": getattr(eval_result, "metadata", {}).get("fixgurobi_full_time", ""),
        "fixgurobi_first_improvement_accepted": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_first_improvement_accepted", False)),
        "fixgurobi_cheap_gate_reject": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_cheap_gate_reject", False)),
        "fixgurobi_compiled_fallback_used": bool(getattr(eval_result, "metadata", {}).get("fixgurobi_compiled_fallback_used", False)),
        "fixgurobi_fixed_scope": str(getattr(eval_result, "metadata", {}).get("fixgurobi_fixed_scope", "")),
        "fixgurobi_config_subtask_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_config_subtask_count", 0) or 0),
        "fixgurobi_release_subtask_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_release_subtask_count", 0) or 0),
        "fixgurobi_payload_fixed_x_order_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_payload_fixed_x_order_count", 0) or 0),
        "fixgurobi_payload_fixed_y_order_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_payload_fixed_y_order_count", 0) or 0),
        "fixgurobi_payload_fixed_z_order_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_payload_fixed_z_order_count", 0) or 0),
        "fixgurobi_payload_fixed_x_row_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_payload_fixed_x_row_count", 0) or 0),
        "fixgurobi_payload_fixed_y_row_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_payload_fixed_y_row_count", 0) or 0),
        "fixgurobi_payload_fixed_z_row_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_payload_fixed_z_row_count", 0) or 0),
        "fixgurobi_fixed_constraint_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_fixed_constraint_count", 0) or 0),
        "fixgurobi_invalid_fix_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_invalid_fix_count", 0) or 0),
        "fixgurobi_fixed_route_arc_count_from_cfg": int(getattr(eval_result, "metadata", {}).get("fixgurobi_fixed_route_arc_count_from_cfg", 0) or 0),
        "fixgurobi_fixed_route_sequence_robot_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_fixed_route_sequence_robot_count", 0) or 0),
        "fixgurobi_fixed_route_sequence_missing_count": int(getattr(eval_result, "metadata", {}).get("fixgurobi_fixed_route_sequence_missing_count", 0) or 0),
