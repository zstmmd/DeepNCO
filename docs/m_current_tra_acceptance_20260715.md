...
- Gurobi baseline JSON: `result/m_current_tra_acceptance_no_structure_m2_gapfix_20260715/current_m_gurobi_baseline.json`
- Gurobi baseline CSV: `result/m_current_tra_acceptance_no_structure_m2_gapfix_20260715/current_m_gurobi_baseline.csv`
- Runtime alias JSON: `result/m_current_tra_acceptance_no_structure_m2_gapfix_20260715/current_m_runtime_aliases.json`
- Gurobi structure exports JSON: `result/m_current_tra_acceptance_no_structure_m2_gapfix_20260715/current_m_structure_exports.json`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GUROBI-M2 | 805 | 384.041 | None | None | nan | False |  |  |  |  | False | tra_gurobi_missing_or_nonfinite_cmax |
