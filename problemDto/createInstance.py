...
class CreateOFSProblem:
    ...
    def generate_problem_by_scale(scale: str = "SMALL", seed: int = OFSConfig.RANDOM_SEED) -> OFSProblemDTO:
        ...
        configs = {
            ...
            "GUROBI-S1": {"map_size": (2, 4), "resources": (2, 2, 60), "data": (2, 18), "bom_complexity": (8, 1), "target_stack_count": 5, "exact_order_sku_counts": (7, 7), "exact_order_sku_quantity_range": (5, 7), "bom_colocated_inventory": True, "bom_colocated_stack_counts": (2, 2), "bom_colocated_disjoint_stack_groups": True, "bom_colocated_support_multiplier": 1.2, "bom_colocated_sku_copy_count": 1, "bom_colocated_chunked_by_stack": True},
            "GUROBI-S2": {"map_size": (2, 4), "resources": (2, 2, 75), "data": (2, 20), "bom_complexity": (8, 1), "target_stack_count": 8, "exact_order_sku_counts": (7, 8), "exact_order_sku_quantity_range": (6, 8), "bom_colocated_inventory": True, "bom_colocated_stack_counts": (2, 3), "bom_colocated_disjoint_stack_groups": True, "bom_colocated_support_multiplier": 1.2, "bom_colocated_sku_copy_count": 1, "bom_colocated_chunked_by_stack": True},
            "GUROBI-S3": {"map_size": (3, 4), "resources": (3, 3, 80), "data": (3, 20), "bom_complexity": (8, 1), "target_stack_count": 6, "exact_order_sku_counts": (6, 7, 7), "exact_order_sku_quantity_range": (5, 7), "bom_colocated_inventory": True, "bom_colocated_stack_counts": (2, 2, 2), "bom_colocated_disjoint_stack_groups": True, "bom_colocated_support_multiplier": 1.2, "bom_colocated_sku_copy_count": 1, "bom_colocated_chunked_by_stack": True},
            ...
            "GUROBI-S6": {"map_size": (3, 5), "resources": (4, 4, 120), "data": (5, 30), "bom_complexity": (8, 1), "target_stack_count": 22, "inventory_cold_filler_probability": 0.25, "exact_order_sku_counts": (5, 6, 6, 6, 5), "exact_order_sku_quantity_range": (8, 10), "bom_colocated_inventory": True, "bom_colocated_stack_counts": (2, 3, 3, 3, 2), "bom_colocated_disjoint_stack_groups": True, "bom_colocated_support_multiplier": 1.2},
            "GUROBI-S7": {"map_size": (3, 5), "resources": (4, 4, 120), "data": (5, 30), "bom_complexity": (8, 1), "target_stack_count": 22, "inventory_cold_filler_probability": 0.25, "exact_order_sku_counts": (5, 6, 6, 6, 5), "exact_order_sku_quantity_range": (9, 11), "bom_colocated_inventory": True, "bom_colocated_stack_counts": (2, 3, 3, 3, 2), "bom_colocated_disjoint_stack_groups": True, "bom_colocated_support_multiplier": 1.2},
        ...
        runtime_configs = getattr(CreateOFSProblem, "RUNTIME_SCALE_CONFIGS", {}) or {}
        for runtime_name, runtime_cfg in dict(runtime_configs).items():
            configs[str(runtime_name).upper()] = dict(runtime_cfg)
